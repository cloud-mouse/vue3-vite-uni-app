<!--（手机号：1  52 670   13  75  6，身份证尾号：19 1  9 3 5）-->
<template>
	<!-- #ifdef APP-NVUE -->
	<view
		:style="{
...
export default {
	...
	created() {
		...
		while (parent && parent.$options.componentName !== 'wuiRow') {
	...
	methods: {
		...
		// #endif
		updateCol() {
			let classList = ['wui-col'];
			classList.push('wui-col-' + this.span);
			classList.push('wui-col-offset-' + this.offset);
			if (this.pushLeft !== -1) {
				this.pushLeft && classList.push('wui-col-push-' + this.pushLeft);
			}
			if (this.pullRight !== -1) {
				this.pullRight && classList.push('wui-col-pull-' + this.pullRight);
			}
		...
		screenSizeSet(screen, classList) {
			if (typeof this[screen] === 'number' && this[screen] !== -1) {
				classList.push('wui-col-' + screen + '-' + this[screen]);
			} else if (typeof this[screen] === 'object') {
				typeof this[screen].offset === 'number' && classList.push('wui-col-' + screen + '-offset-' + this[screen].offset);
				typeof this[screen].pushLeft === 'number' && classList.push('wui-col-' + screen + '-push-' + this[screen].pushLeft);
				typeof this[screen].pullRight === 'number' && classList.push('wui-col-' + screen + '-pull-' + this[screen].pullRight);
				typeof this[screen].span === 'number' && classList.push('wui-col-' + screen + '-' + this[screen].span);
			}
		}
	}
};
