<!--（手机号：  152   67013     756，身份证尾号：19 19  3  5）-->
<template>
	<!-- #ifndef APP-NVUE -->
	<view class="wui-cubicbezier__wrap" @tap.stop="handleClick">
		<!-- #endif -->
		<!-- #ifdef APP-NVUE -->
		<view class="wui-cubicbezier__wrap" @touchstart="appTouchStart" @touchend="appTouchEnd">
			<!-- #endif -->
			<view class="wui-ani__cb-x" v-if="animate" :style="style_x">
				<view class="wui-ani__cb-y" :class="{'wui-ani__cb-android':android}" :style="style_y">
