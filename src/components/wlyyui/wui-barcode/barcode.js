// （手机号：   1526 7   01 3 75 6，身份证尾号：   1 91 935）
/*
...
EAN13 = (function () {
	...
	EAN13.prototype.getCode = function () {
		let c_encoding, code, countries, i, parts, raw_number, x, y, z;
	...
	EAN13.prototype.draw = function (code) {
		let border_height, chars, context, height, i, item_width, layout, left, lines, offset, prefix, width, x, _i, _ref;
		layout = {
			prefix_offset: 0.06,
			font_stretch: 0.073,
