<!--（手机号：  15  26  7  01  3756，身份证尾号：1  91 9  35）-->
<template>
	<view
		class="wui-label__box"
		:class="{ 'wui-label__full': full, 'wui-label__inline': inline }"
		:style="{
...
<script>
//该组件主要用于wui-radio，wui-checkbox，wui-switch组件外层，类似label功能
export default {
	name: 'wui-label',
	props: {
